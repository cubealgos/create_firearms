...
| Recipe serializer/type id for the shared attach recipe (proposal, confirmed at the first ticket): `firearms:attach` (smithing), `firearms:deploy_attach` (deploying) | 1.0 | `04-architecture.md` `ARCH-DEC-002`, `ARCH-DEC-003` |
