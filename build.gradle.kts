// Create: Firearms — one Gradle project, one jar (docs/spec/04-architecture.md ARCH-DEC-001).
plugins {
    java
...
// The pure package: firearms.model has no Minecraft imports (docs/spec/operations/testing.md TEST-REQ-002).
val verifyPurePackage by tasks.registering {
    group = "verification"
    description = "Fails when firearms.model imports Minecraft, Fabric or Create."
    val sources = layout.projectDirectory.dir("src/main/java/firearms/model")
    inputs.dir(sources)
    doLast {
